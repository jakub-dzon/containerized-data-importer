...
type ReconcileCDI struct {
	...
	certManager certrotation.CertManager
...
func (r *ReconcileCDI) add(mgr manager.Manager) error {
	...
	cm, err := certrotation.NewCertManager(mgr, r.namespace)
	if err != nil {
		return err
	}
...
func (r *ReconcileCDI) getCertificateDefinitions() []sdkcertapi.CertificateDefinition {
